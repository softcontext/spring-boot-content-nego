...
public abstract class AbstractPdfView extends AbstractView {
	 ...
	 * 
	 * @param model
	 *            the model, in case meta information must be populated from it
	 * @param writer
	 ...
	 * {@code PageLayoutSinglePage}, but can be subclassed. The subclass can
	 * either have fixed preferences or retrieve them from bean properties
	 * defined on the View.
	 * 
	 * @return an int containing the bits information against PdfWriter
	 *         definitions
	 */
	 ...
	 * etc. This method is called after assigning a PdfWriter to the Document
	 * and before calling {@code document.open()}.
	 * 
	 * @param model
	 *            the model, in case meta information must be populated from it
	 * @param document
	 *            the iText document being populated
	 * @param request
	 *            in case we need locale etc. Shouldn't look at attributes.
	 */
	 ...
	 * setting cookies or other HTTP headers. The built PDF document itself will
	 * automatically get written to the response after this method returns.
	 * 
	 * @param model
	 *            the model Map
	 * @param document
